                ...
                <div class="card-body" id="myDiv">
                    ...
                    <div class="row">
                       <div class="col-md-12 anime fadeIn" style="margin-top: 22px;">
                            <table id="histoTable2" class="display table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>Code</th>
                                        <th>Etablissement</th>
                                ...
                                <tbody>
                                    <tr v-for="(etab, index) in etabs" :key="etab.id_etab" :id="etab.id_etab">
                                        ...
                                        <td>{{ etab.nom_etab }}</td>
                                        <td>{{ etab.m6 | splitNumber }}</td>
                                        <td>{{ etab.m5 | splitNumber }}</td>
                                        <td>{{ etab.m4 | splitNumber }}</td>
                                        <td>{{ etab.m3  | splitNumber }}</td>
...
import { supression, supressionAll,informer,reussie } from './../alert.js';
    export default {
        ...
        mounted() {
            ...
            this.ref2 = $('#histoTable2');
            this.getCisco();
            this.activeDataTable2();
        ...
        methods:{
            ...
            activeDataTable2(){
                this.$nextTick(() => {
                    this.table2 = this.ref2.DataTable({
                	"pageLength": 5
				    });
                });
			},
            getClasse(idZap){ 
                return axios.get('/effectifs_classe/' + idZap + '/'+ this.niveau).then(res => {
                    ...
                    if ($.fn.DataTable.isDataTable('#histoTable2')) {this.table2.destroy();}
                    this.activeDataTable2(); 
            ...
            updateRow(etab){
                ...
                this.etabs[index].m6 = etab.classe.m6;
                this.etabs[index].m5 = etab.classe.m5;
                this.etabs[index].m4 = etab.classe.m4;
                this.etabs[index].m3 = etab.classe.m3;
                this.etabs[index].total  = etab.classe.m6 + etab.classe.m5 
                + etab.classe.m4 + etab.classe.m3;
            },
            update(param){
                this.errors = []; 
                ...
                this.etab.classe = {};
                this.etab.classe.m6 = param.m6;
                this.etab.classe.m5 = param.m5;
                this.etab.classe.m4 = param.m4;
                this.etab.classe.m3 = param.m3; 
            },
            save(){
